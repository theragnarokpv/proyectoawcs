    ...
    <h2 class="name_pag">Iniciar Sesión</h2>
        <div class="login-container">
            ...
            <form action="include/functions/login.php" method="post" >
                <label for="email" class="sesion-label">Usuario:</label>
                <input type="text" class="session-input"  name="username" required>

                <label for="password" class="sesion-label">Contraseña:</label>
                <input type="password" class="session-input" name="password" required>
                ...
                <div class="recover-content-log">
                    ...
                    <a href="registro.php" class="recover redi-link" >Registrarse</a>
                </div>
            </form>
